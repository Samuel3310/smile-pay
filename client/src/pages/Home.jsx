      ...
      <main className="w-full  bg-[#EDF4F9] pt-5 md:pt-[50px] lg:pt-[100px] relative overflow-x-hidden">
          ...
          <article className="flex flex-col md:flex-row px-10 items-center justify-center py-4">
            ...
            >
              ...
              <div className="flex gap-5 my-3">
                <Link
                  to="/login"
                  className="btn_color font-semibold text-white bordered text-nowrap btn-max"
                >
                  Get Started
                </Link>
        ...
        <article className="bg-white w-full mt-4 md:mt-[60px] p-10 ">
          ...
          <section className="w-full min-h-screen py-10 px-1 flex flex-col md:flex-row gap-10 ">
            <div className="md:basis-[60%] w-full flex flex-col justify-center gap-5 md:p-10 p-2">
              ...
              <p className="text-base" data-aos="fade-right">
                Semper quis mus ipsum fringilla vulputate. Parturient class
                libero nostra a sollicitudin consectetuer faucibus.
              </p>
              <p className="text-sm text-justify" data-aos="fade-down">
                ...
                nullam ipsum tempus consequat metus curabitur ridiculus
                himenaeos. Gravida nibh consectetur nam augue facilisi amet
                parturient.
              </p>
              <div>
          ...
          <section className="flex justify-center items-center md:gap-10 gap-2 flex-col md:flex-row mb-10">
            <div className="  md:bg-gray-200 relative  flex sm:flex-row flex-col gap-1 md:flex-col md:after:contents-[''] md:after:w-2 md:after:h-full md:after:bg-yellow-500 md:after:block md:after:absolute text-xl font-semibold shadow-sm p-2 md:p-0">
        ...
        >
          <div className="md:basis-3/5 basis-4/5 pt-3 pl-10 flex flex-col gap-5">
            ...
            <p className="text-gray-300">
              ...
              Dignissimos, doloribus distinctio asperiores sit eligendi
              reiciendis fugit suscipit corporis unde quasi!
            </p>
            <div>
        ...
        >
          <div className="max-w-[700px] mx-auto flex items-center justify-center flex-col gap-5">
            ...
            <p className="text-md text-center text-gray-400">
              ...
              blandit ac. Et dignissim nostra per ac scelerisque nullam
              fermentum.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-8  md:flex-row mt-4 md:gap-5 px-5">
            ...
            <div className="basis-[50%]">
              <p className="text-md">
                ...
                cubilia quis porttitor fermentum. Laoreet congue vulputate
                ornare habitasse si interdum.
              </p>
            </div>
          </div>
        ...
        >
          <div className="md:basis-3/6 basis-4/5 pt-3 pl-10 flex flex-col gap-5">
            <h1 className="text-max-48 text-white md:font-bold font-semibold">
              Get paid faster and more securely with our payment gateway
              solution
            </h1>
            <p className="text-gray-300">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit.
        ...
        <section className="grid md:grid-cols-4 grid-cols-2 gap-4 px-5 py-4 bg-white border-b-2 border-l-gray-500">
          <div className=" pl-4">
            <p className="text-2xl font-bold md:text-5xl text-blue-500">17K+</p>
            <span>User Download</span>
          </div>
          <div className="border-l-2 border-blue-500 pl-4">
            <p className="text-2xl font-bold md:text-5xl text-blue-500">12K+</p>
            <span>Active User</span>
          </div>
          <div className="border-l-2 border-blue-500 pl-4">
            <p className="text-2xl font-bold md:text-5xl text-blue-500">
              4.8/5
            </p>
            <span>User Rating</span>
          </div>
          <div className="border-l-2 border-blue-500 pl-4">
            <p className="text-2xl font-bold md:text-5xl text-blue-500">15+</p>
            <span>Yeasr Experience</span>
          </div>
        </section>
        <section className="w-full min-h-screen py-10 px-1 flex flex-col md:flex-row-reverse gap-10 bg-white">
          <div className="md:basis-[60%] w-full flex flex-col justify-center gap-5 md:p-10 p-2">
            <h1>
              <span className="title" data-aos="fade-right">
                Why Choose us
          ...
          >
            <img
              src="design16.png"
              alt=""
              className="relative  w-[308px] h-[365px] md:h-[500px] md:w-[400px] md:-top-[26px] -top-[38px] md:scale-110  z-10 "
            />
            <img
              src="blue-deep-blue.jpg"
              alt=""
              className="absolute w-full rounded-2xl h-[290px]  md:h-[500px]"
            />
          </div>
        </section>
